...
export default function RequestUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = requestRecord
      ...
      : initialValues;
    setOriginAirport(cleanValues.originAirport);
    setOriginAirportCode(cleanValues.originAirportCode);
    setDestinationAirport(cleanValues.destinationAirport);
    setDestinationAirportCode(cleanValues.destinationAirportCode);
    setRequestedDepartureDate(cleanValues.requestedDepartureDate);
    setCargoType(cleanValues.cargoType);
    setCargoWeight(cleanValues.cargoWeight);
    setCargoVolume(cleanValues.cargoVolume);
    setCargoLength(cleanValues.cargoLength);
    setCargoWidth(cleanValues.cargoWidth);
    setCargoHeight(cleanValues.cargoHeight);
    setCargoSpecialHandlingInformation(
      cleanValues.cargoSpecialHandlingInformation
    );
    setErrors({});
  };
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Request, idProp)
        : requestModelProp;
